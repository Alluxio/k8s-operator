...
function verifyMasterTemplate {
  ...
  helm template "${SCRIPT_DIR}"/../../deploy/charts/alluxio --show-only templates/"${statefulset_relative_path}" -f "${SCRIPT_DIR}"/config_test.yaml --debug > "${TARGET_DIR}/${statefulset_relative_path}"
...
function verifyWorkerTemplate {
  ...
  helm template "${SCRIPT_DIR}"/../../deploy/charts/alluxio --show-only templates/"${deployment_relative_path}" -f "${SCRIPT_DIR}"/config_test.yaml --debug > "${TARGET_DIR}/${deployment_relative_path}"
...
function verifyFuseTemplate {
  ...
  helm template "${SCRIPT_DIR}"/../../deploy/charts/alluxio --show-only templates/"${daemonset_relative_path}" -f "${SCRIPT_DIR}"/config_test.yaml --debug > "${TARGET_DIR}/${daemonset_relative_path}"
...
function verifyConfTemplate {
  ...
  helm template "${SCRIPT_DIR}"/../../deploy/charts/alluxio --show-only templates/"${configmap_relative_path}" -f "${SCRIPT_DIR}"/config_test.yaml --debug > "${TARGET_DIR}/${configmap_relative_path}"
